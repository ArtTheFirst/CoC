...
Public Class clCrTransfers
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CoC_Server.clCrTransfers.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedclCrTransfers
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As clCrTransfers = New clCrTransfers()
        rpt.Site = Me.Site
        Return rpt
    End Function
