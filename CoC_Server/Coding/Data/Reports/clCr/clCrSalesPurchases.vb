...
Public Class clCrSalesPurchases
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CoC_Server.clCrSalesPurchases.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedclCrSalesPurchases
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As clCrSalesPurchases = New clCrSalesPurchases()
        rpt.Site = Me.Site
        Return rpt
    End Function
