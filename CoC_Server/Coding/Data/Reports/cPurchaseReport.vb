...
Public Class cPurchaseReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CoC_Server.cPurchaseReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcPurchaseReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cPurchaseReport = New cPurchaseReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
